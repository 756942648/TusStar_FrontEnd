      ...
      >
        ...
        <el-form-item label="职位类型" prop="type">
          <el-select v-model="ruleForm.type" placeholder="请选择">
            ...
            <el-option label="媒体" value="beijing"></el-option>
            <el-option label="金融" value="beijing"></el-option>
            <el-option label="教育" value="beijing"></el-option>
            <el-option label="服务业" value="beijing"></el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="工作经验" prop="experience">
          <el-select v-model="ruleForm.experience" placeholder="请选择">
            <el-option label="无要求" value="shanghai"></el-option>
            <el-option label="1年" value="beijing"></el-option>
            <el-option label="2年" value="shanghai"></el-option>
            <el-option label="3年" value="beijing"></el-option>
            <el-option label="4年" value="shanghai"></el-option>
            <el-option label="5年以上" value="beijing"></el-option>
          </el-select>
        </el-form-item>
